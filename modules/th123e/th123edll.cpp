...
#ifdef __GNUC__
	asm volatile("movl %0, %%edx" : : "r" (orig_edx) : "%edx");
#else
...
#ifdef __GNUC__
#error "TODO fix assembly call for GCC compiler"
	//orig_font_func(eax_value, a, b, c);
#else
...
#ifdef __GNUC__
static void __stdcall __attribute__((regparm(1))) font_passthrough(unsigned int *eax_value, unsigned int a, void *b, void *c) {
	_font_passthrough(eax_value, a, b, c);
}
#else
