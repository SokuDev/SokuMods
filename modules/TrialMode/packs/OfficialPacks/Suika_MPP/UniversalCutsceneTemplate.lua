...
-- "type": "combo",
--
-- Alternatively, you can change it using the in game editor in the misc tab.
--
-- Dialogue Instructions:
-- 	The first three characters after the " marks who is speaking.
...
--	For example, the dialogue below shows the left character's happy sprite and no sprite for the right character.
--      "rH " would show no sprite for the left character and a happy sprite for the right character.
...
local dialogs = {
	"ltH During MPP there are several options to mix up the opponent: <br> 5a is low unblockable, 5b crushes high, and 5c crushes low.",
	"ltH j5b is high unblockable and j5a is low unblockable, <br> though, most characters can crouch under it.",
	"ltH However against characters with a tall crouch like Yukari...",
	"lCE You can do this!"
	--Battle here
}
