...
local dialogs = {
	"lH Welcome to the MPP trial pack",
	"lH This pack will cover setups, combos, and other oddities about<br> Suika's 4 cost spell card Great Oni:'Missing Purple Power'",
	"lC Now, lets get started"
	--Battle here
}
...
--		Use the position.x fields to change where the characters are standing.
			battleMgr.leftCharacterManager.position.x = 900
			...
			battleMgr.rightCharacterManager.position.x = 950
