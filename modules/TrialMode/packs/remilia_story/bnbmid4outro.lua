...
local dialogs = {
	...
	"rcSReimu came by and she was acting...<br>rather awkwardly I would say.",
	"lWhSo she is here, too...",
	"rWAI felt like she already knew<br>what she was looking for, and not<br>just following her instinct.",
	"rWEThough it is baseless information...",
	"lhEYet it is plenty enough.",
	"lHEI shall commend you for being the first<br>one to have any semblance of an idea!",
	"rHCThank you...",
	--Remilia get away...
	"r AWait!",
