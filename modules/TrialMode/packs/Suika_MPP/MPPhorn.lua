...
local dialogs = {
	"ltc A lesser know fact about MPP is that during the <br>idle animation, the horn has a hitbox on the way down.",
	"lHE This hitbox is an unblockable bullet, so it can be <br> used to catch an opponent off guard.",
	"lHE It allows for combos after it connects as well."
	--Battle here
}
