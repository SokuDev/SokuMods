...
LuaBattleAnimation::LuaBattleAnimation(const char *packPath, const char *script)
{
	...
	(*this->_lua)[sol::create_if_nil]["enums"]["actions"] = std::map<std::string, SokuLib::Action>{
		...
		{ "ACTION_LILIPAD_FORWARD_DASH", SokuLib::ACTION_LILIPAD_FORWARD_DASH },
		{ "ACTION_LILIPAD_BACKDASH", SokuLib::ACTION_LILIPAD_BACKDASH },
		...
		{ "ACTION_SUWAKO_LILIPAD_6A", SokuLib::ACTION_SUWAKO_LILIPAD_6A },
