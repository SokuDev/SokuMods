...
int __fastcall CBattleManager_OnProcess(SokuLib::BattleManager *This)
{
	...
	This->leftCharacterManager.objectBase.hp -= This->leftCharacterManager.cardCount;
	This->rightCharacterManager.objectBase.hp -= This->rightCharacterManager.cardCount;
	return ret;
}
